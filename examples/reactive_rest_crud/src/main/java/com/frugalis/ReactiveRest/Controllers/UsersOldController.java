...
public class UsersOldController {
	...
	@PutMapping("{id}")
	public Mono updateById(@PathVariable("id") final String id, @RequestBody final Users user) {
		Users updatedUser = new Users(user.getName(), user.getAge());
	...
	public Mono delete(@PathVariable final String id) {
		//Mono<Users> result = userRepository.findById(Integer.parseInt(id));
